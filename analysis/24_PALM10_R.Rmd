---
title: "Genotype PALM10_R re-demultiplexed"
author: 
- Y Zhan, B Ozay
...
Genotype data integration of ONT enrichment experiment with 10X expression data for PALM10_R sample
...
```{r}
genotype_file = "data/enrichment/PALM10_R.csv"
# genotype_file = "data/enrichment/sAML1.csv"
wes_file = "data/PALM_10_R.maf"
sample_id = "PALM10_R"
```

Information from the log files:
```{r}
blaze_log="data/enrichment/PALM10_R_blaze.log"
target_log="data/enrichment/PALM10_R_target.log"
genotype_log="data/enrichment/PALM10_R_genotype.log"
```
...
Next, we quantified the number of cells with multiple genotyped mutations, as shown in the tables below. We present the results for different mutation combinations. For this specific samples, we will look at these genes since they are the most genotyped:

```{r}
# Define the genes of interest
gene_interest <- c('PRDX1', 'PFKP',"DGUOK","G3BP1")
...
gene_interest <- c('PRDX1', 'PFKP',"DGUOK")
co_occurence <- get_coccurence(genotype_file, variants, gene_interest)
DT::datatable(
  co_occurence,
  extensions = 'Buttons',
...
gene_interest <- c('PFKP',"DGUOK","G3BP1")
co_occurence <- get_coccurence(genotype_file, variants, gene_interest)
DT::datatable(
  co_occurence,
  extensions = 'Buttons',
...
gene_interest <- c('PRDX1',"PFKP","G3BP1")
co_occurence <- get_coccurence(genotype_file, variants, gene_interest)
DT::datatable(
  co_occurence,
  extensions = 'Buttons',
...
gene_interest <- c('PRDX1',"DGUOK","G3BP1")
co_occurence <- get_coccurence(genotype_file, variants, gene_interest)
DT::datatable(
  co_occurence,
  extensions = 'Buttons',
