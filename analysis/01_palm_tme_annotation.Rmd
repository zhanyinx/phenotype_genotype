...
```{r}
srat = readRDS("data/00_palm_malignant_non_malignant_annotation.rds")
...
```{r}
if(!file.exists("data/01_palm_tme_annotation.rds")){
  saveRDS(srat, "data/01_palm_tme_annotation.rds")
}
```
