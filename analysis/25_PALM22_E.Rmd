---
title: "Genotype PALM22_E re-demultiplexed"
author: 
- Y Zhan, B Ozay
...
Genotype data integration of ONT enrichment experiment with 10X expression data for PALM22_E sample
...
```{r}
genotype_file = "data/enrichment/PALM22_E.csv"
# genotype_file = "data/enrichment/sAML1.csv"
wes_file = "data/PALM22_E.maf"
sample_id = "PALM22_E"
```

Information from the log files:
```{r}
blaze_log="data/enrichment/PALM22_E_blaze.log"
target_log="data/enrichment/PALM22_E_target.log"
genotype_log="data/enrichment/PALM22_E_genotype.log"
```
...
gene_interest <- c('DRAP1', 'IDH2',"NPM1")
