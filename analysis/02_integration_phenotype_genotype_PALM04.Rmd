...
Next, we quantified the number of cells with multiple genotyped mutations, as shown in the tables below. We present the results for different mutation combinations. For this specific samples, we will look at these genes since they are the most genotyped: LSM3, NRAS, BAX, NPM1, STAG2
...
gene_interest <- c('STAG2', 'NRAS', 'LSM3')
co_occurence <- get_coccurence1(genotype_file, gene_interest)
DT::datatable(
  co_occurence,
  extensions = 'Buttons',
...
gene_interest <- c('NPM1', 'BAX', 'NRAS', 'LSM3')
co_occurence <- get_coccurence1(genotype_file, gene_interest)
DT::datatable(
  co_occurence,
  extensions = 'Buttons',
...
gene_interest <- c('STAG2', 'BAX', 'NRAS', 'LSM3')
co_occurence <- get_coccurence1(genotype_file, gene_interest)
DT::datatable(
  co_occurence,
  extensions = 'Buttons',
...
gene_interest <- c('STAG2', 'NPM1', 'NRAS', 'LSM3')
co_occurence <- get_coccurence1(genotype_file, gene_interest)
DT::datatable(
  co_occurence,
  extensions = 'Buttons',
...
gene_interest <- c('STAG2', 'NPM1', 'BAX', 'NRAS', 'LSM3')
co_occurence <- get_coccurence1(genotype_file, gene_interest)
DT::datatable(
  co_occurence,
  extensions = 'Buttons',
