---
title: "Genotype PALM11_E re-demultiplexed"
author: 
- Y Zhan, B Ozay
...
```{r}
genotype_file = "../../results/palm/second/PALM11_E_dorado/PALM11_E_dorado.csv"
# genotype_file = "data/enrichment/sAML1.csv"
wes_file = "data/PALM_11_E.maf"
sample_id = "PALM11_E"
```

Information from the log files:
```{r}
blaze_log="../../results/palm/second/PALM11_E_dorado/logs/blaze.log"
target_log="../../results/palm/second/PALM11_E_dorado/logs/target.log"
genotype_log="../../results/palm/second/PALM11_E_dorado/logs/genotype.log"
```
...
gene_interest <- c('BAX', 'KAT6A',"KRAS","NPM1")
...
gene_interest <- c('BAX', 'KAT6A',"KRAS")
co_occurence <- get_coccurence(genotype_file, variants, gene_interest)
DT::datatable(
  co_occurence,
  extensions = 'Buttons',
...
gene_interest <- c('BAX','KAT6A',"NPM1")
co_occurence <- get_coccurence(genotype_file, variants, gene_interest)
DT::datatable(
  co_occurence,
  extensions = 'Buttons',
...
gene_interest <- c('KAT6A',"KRAS","NPM1")
co_occurence <- get_coccurence(genotype_file, variants, gene_interest)
DT::datatable(
  co_occurence,
  extensions = 'Buttons',
