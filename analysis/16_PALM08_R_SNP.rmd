...
```{r}
genotype_file = "data/enrichment/PALM08_R_snp.csv"
# genotype_file = "data/enrichment/sAML1.csv"
```

Information from the log files:
```{r}
blaze_log="data/enrichment/palm08r_snp_blaze.log"
target_log="data/enrichment/palm08r_snp_target.log"
genotype_log="data/enrichment/palm08r_snp_genotype.log"
```
