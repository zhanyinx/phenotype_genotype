...
```{r}
genotype_file = "data/enrichment/palm08r_mut_snp.csv"
# genotype_file = "data/enrichment/sAML1.csv"
```

Information from the log files:
```{r}
blaze_log="data/enrichment/palm08r_mut_snp_blaze.log"
target_log="data/enrichment/palm08r_mut_snp_target.log"
genotype_log="data/enrichment/palm08r_mut_snp_genotype.log"
```
...
The mutation we analyzed previously is:

77887134	77887134	C	T	ADCK1, shown as ADCK177887134T on the table. 

Compared to the previous analysis, where ADCK1 had 490 MUT and 92 WT cells, it now has 499 MUT and 89 WT.
