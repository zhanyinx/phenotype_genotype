...
```{r}
genotype_file = "data/enrichment/PALM11_E.csv"
...
```{r}
blaze_log="data/enrichment/palm11_e_blaze.log"
target_log="data/enrichment/palm11_e_target.log"
genotype_log="data/enrichment/palm11_e_genotype.log"
```
