...
We selected cells where CCND2 and TIMM23 are either both mutated, or only TIMM23 This resulted in the following number of cells, representing the intersection of genotyped cells and those passing scRNA-seq filters.  
