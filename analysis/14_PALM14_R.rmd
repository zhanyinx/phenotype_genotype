...
Genotype data integration of ONT enrichment experiment with 10X expression data for PALM14_R sample
...
```{r}
genotype_file = "data/enrichment/PALM14_R.csv"
wes_file = "data/PALM_14_R.maf"
sample_id = "PALM14_R"
```
Information from the log files:
```{r}
blaze_log="data/enrichment/palm14_r_blaze.log"
target_log="data/enrichment/palm14_r_target.log"
genotype_log="data/enrichment/palm14_r_genotype.log"
```
...
gene_interest <- c('CCND2', 'TIMM23', 'UBTF')
...
metadata$cellid = gsub("PALM14_R_", "", metadata$cellid)
...
srat$cellid = gsub("PALM14_R_", "", srat$cellid)
